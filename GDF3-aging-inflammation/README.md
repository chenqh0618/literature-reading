...
![图1](images/page_003.png)
*图1：GDF3通过调控炎症性ATMs促进内毒素诱导的炎症。该图展示了LPS对老年小鼠体温、VAT中CD11c+ ATMs比例、以及Gdf3基因敲除对炎症反应影响的系列实验结果。*
...
![图2](images/page_005.png)
*图2：BRD4通过调控Gdf3表达来影响SMAD2/3信号。该图展示了BRD4抑制剂JQ1对Gdf3表达、ATMs表型及SMAD2/3磷酸化的影响。*
...
![图3](images/page_007.png)
*图3：SMAD3抑制剂SIS3能有效抑制炎症并提高生存率。该图展示了SIS3处理对ATMs表型、炎症因子以及老年小鼠在LPS攻击下存活率的影响。*
...
![图4](images/page_008.png)
*图4：GDF3调控衰老ATMs的染色质可及性。ATAC-seq结果显示，衰老导致染色质开放性增加，而Gdf3缺失则逆转了这一变化。*
...
![图5](images/page_010.png)
*图5：Gdf3缺失通过促进染色质重塑来减少炎症。该图展示了Gdf3缺失如何影响H3K27me3水平及相关染色质修饰酶的表达，最终导致炎症相关基因的下调。*
...
![图3s](images/page_007.png)
*图3s：人体队列研究数据显示，GDF3水平与年龄及炎症标志物显著相关。*
